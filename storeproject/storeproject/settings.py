...
Generated by 'django-admins startproject' using Django 1.8.4.
...
ALIPAY_PUBLIC_KEY = open(os.path.join(BASE_DIR,'alipay/app_private_key.txt')).read()

APP_PRIVATE_KEY  = open(os.path.join(BASE_DIR,'alipay/alipay_public.txt')).read()
